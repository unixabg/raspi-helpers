...
echo "$(date) - Install the dependencies for Jasper included as Debian packages..." >> ~/jasper-installer.log
# Install the dependencies  for Jasper included as Debian packages
sudo apt-get install libsphinxbase1 --yes
